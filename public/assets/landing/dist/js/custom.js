...
(function ($) {
    ...
    $('.yt_player_iframe').each(function(e){
        e.preventDefault();
        console.log('video doit etre en pause');
    ...
    $(".drop-link").click(function (e) {
        e.preventDefault();
        console.log("drop down events");
        console.log("p status visibility: ", $(".drop-link-p").val());
        /*  $('.drop-link p').toggle('slow',()=>{
            if($(".drop-link p").is(":visible")){
