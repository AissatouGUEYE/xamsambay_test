$(document).ready(function () {
    ...
    $("#upf").click(function (e) {
        ...
        $(".up").select2({
            ...
            width: '100%',
            dropdownParent: 'div#prod'
        });
    });


    $(".select-transversal").select2({
        /* the following code is used to disable x-scrollbar when click in select input and
            take 100% width in responsive also */
        dropdownAutoWidth: false,
        width: '100%',
    ...
    $(".select-pluvio").select2({
        /* the following code is used to disable x-scrollbar when click in select input and
            take 100% width in responsive also */
        dropdownAutoWidth: false,
        width: '100%',
        dropdownParent: "#modal-pluvio"
    });

    $(".select-gerant").select2({
        /* the following code is used to disable x-scrollbar when click in select input and
            take 100% width in responsive also */
        dropdownAutoWidth: false,
        width: '100%',
        dropdownParent: "#modal-gerant"
    });
    // $("#lpf").click(function (e) {
    //     e.preventDefault();
        $(".select-multitransversal").select2({
            /* the following code is used to disable x-scrollbar when click in select input and
            take 100% width in responsive also */
            dropdownAutoWidth: true,
            width: '100%',
