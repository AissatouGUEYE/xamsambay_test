      ...
      <div class="row">
        <div class="col s12 m7">
          <div class="display-flex media">
            <a href="#" class="avatar">
              <img src="{{asset('assets/images/avatar/avatar-18.png')}}" alt="users view avatar" class="z-depth-4 circle"
                height="64" width="64">
            </a>
...
<div style="bottom: 50px; right: 19px;" class="fixed-action-btn direction-top">
  <button class="btn-floating btn-large gradient-45deg-light-blue-cyan gradient-shadow  modal-trigger"  data-target="modal3" >
