...
<div class="card">
  <div class="card-content">
    ...
    <div class="row">
      <form  method="POST"  id="formAddEntity"   action="#" data-id="{{$entityInfos['id']}}">
        @csrf
        <div class="col s12">
          <div class="card-content pb-0">
            <div class="row">
              <div class="input-field col s6">
                <input id="nom_entite" type="text" class="validate" name="nom_entite" value="{{$entityInfos['nom_entite']}}">                
                <label class="active" for="nom_entite">Nom entité</label>
              </div>
              <div class="input-field col s6">
                <select class="select2 browser-default" id="type_entite" name="type_entite" value="">
                  <option value="{{$entityInfos['type_entite']}}" disabled selected>{{$entityInfos['nom_typentite']}}</option>
                </select>                
            ...
            <div class="row">
              <div class="input-field col s12">
                <input id="description" type="text" class="validate" name="description" value="{{$entityInfos['description']}}">                
...
<!-- START RIGHT SIDEBAR NAV -->
    ...
    <script src="{{asset('assets\js\crud\gestion\utilisateurs\role\update.js')}}"></script>
