...
<div class="card">
    <div class="card-content">
        <h4 class="card-title">Modification entité</h4>
        <div class="row">
                        ...
                        <div class="row">
                            <div class="input-field col s12">
                                ...
                                <div class="col s12 display-flex justify-content-end mt-1">
                                    <button id="formAddEntitybtn" type="submit" class="btn indigo">Enregistrer</button>
