...
@section('ariane')
    ...
    <li class="breadcrumb-item">
        <a href="{{ url('/admin/role') }}">Rôles</a>
    </li>
    <li class="breadcrumb-item active" style="color:#ffe900">Nouveau Rôle</li>
@endsection
<div class="card">
                    ...
                    <div class="card-content pb-0">
                        <div class="row">
                            <div class="input-field col s6">
                                ...
                                <label class="active" for="nom_entite">Nom de l'organisation</label>
                            </div>
                            <div class="input-field col s6">
                                <select class="select2 browser-default" id="type_entite" name="type_entite">
                                    <option value="" disabled selected>--Type de l'organisation--</option>
                                </select>
                                <label class="active" for="type_entite">Type de l'organisation</label>
                            </div>
                        </div>
                        <div class="row">
