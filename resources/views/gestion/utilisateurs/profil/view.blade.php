            ...
            <div class="row">
                <div class="col s12 m7">
                    <div class="display-flex media">
                        <a href="#" class="avatar">
                            <img @if (isset($user[0]->logo) && $user[0]->logo != '') src="{{ asset('storage/' . $user[0]->logo) }}"  @else src="{{ asset('assets/images/avatar/person-icon.png') }}" @endif
                        ...
                        <div class="media-body">
                            ...
                            @if ($user[0]->role)
                                <span>Role:</span>
                                <span class="users-view-id">{{ $user[0]->role }}</span>
                            @else
                                <span>Entite:</span>
                                <span class="users-view-id">{{ $user[0]->nom_entite }}</span>
                            @endif
                        </div>
                    </div>
                </div>
                <div class="col s12 m5 quick-action-btns display-flex justify-content-end align-items-center pt-2">
                    {{-- edit User --}}
                    @if ($_SESSION['role'] == 'ONG')
                        <a href='{{ url("/ong/utilisateurs/edit/$id") }}' class="btn-small indigo">Edit</a>
                    @else
                        ...
                        <table class="striped">
                            <tbody>
                                <tr>
                                    ...
                                    <td></td>
                                    <td>Adresse: {{ $user[0]->localite }},
                                        {{ $user[0]->commune }},{{ $user[0]->departement }}</td>
                                </tr>
                                <tr>
