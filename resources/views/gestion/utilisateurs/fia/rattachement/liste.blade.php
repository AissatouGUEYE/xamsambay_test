...
@section('ariane')
    ...
    <li class="breadcrumb-item active" style="color:#ffe900">Listes des Commununes rattachées au FIA
    </li>
@endsection
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col s4">
                            <a type="button" class="btn green waves-effect waves-light btn-sm ml-3 right"
                                href="/entite/fia/rattachement/create/{{ $id }}"><i
                                    ...
                                    <tr>
                                        ...
                                        @if ($_SESSION['role'] == 'SERVICE_ETATIQUE')
                                            <td> <a href="#" id="{{ $entities->id }}"
                                                    class="px-1 supprimer_rattachement">
