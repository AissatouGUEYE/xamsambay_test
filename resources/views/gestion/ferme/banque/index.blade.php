...
@section('ariane')
    ...
    <li class="breadcrumb-item">
        <a href="/ferme/finance/banque">Banque</a>
    </li>
                ...
                <div class="row ">
                    <div class="col s12">
                        <ul class="tabs">
                            ...
                            <li class="tab col m6"><a href="#caisse">Banque</a></li>
                        </ul>
                    </div>
                    ...
                    <div id="transaction">
                        ...
                        <div class="responsive-table">
                            <table id="statsTable" class="table display striped">
                                ...
                                <tbody id="">
                                    @isset($banques)
                                        @foreach ($banques as $entities)
                                            <tr>
                                                <td>
                                                    {{ date('d/m/Y', strtotime($entities->created_at)) }}</td>
                                                <td>
                                                    {{ $entities->montant }}
                                                </td>
                                                <td>
                                                    {{ $entities->prenom }} {{ strtoupper($entities->nom) }}
                                                </td>
                    ...
                    <div id="caisse">
                        ...
                        <div class="card-body">
                            <form method="POST" id="banqueForm" action='{{ route('ferme.banque.create') }} '
