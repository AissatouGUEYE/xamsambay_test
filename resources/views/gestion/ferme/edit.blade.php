...
@section('ariane')
    ...
    <li class="breadcrumb-item active" style="color:#ffe900">Modification Activité
    </li>
@endsection
<div class="row">
            ...
            <div class="card">
                <div class="card-content pb-0">
                    <div class="card-header mb-2">
                        <h4 class="card-title">Modification Activité</h4>
                    </div>
                    <div class="card-body">

                        <div class="row">
                           
                            <input id="id" name="id" value="{{ $activiteInfos['id'] }}" hidden>
                            <input id="id_ferme" name="id_ferme" value="{{ $activiteInfos['id_ferme'] }}" hidden>
                            <div class="input-field col s6">
                                <input id="commune" type="text" class="validate" name="activite"
                                    value="{{ $activiteInfos['libelle'] }}">
                                <label class="active" for="produit">Nom de l'Activité</label>
                            </div>
                        ...
                        <div class="row">
                            <div class="input-field col s12">
                                ...
                                <div class="col s12 display-flex justify-content-end mt-1">
                                    <button type="submit" id="formModActiviteByAdminBtn" class="btn indigo">
                                        Enregistrer</button>
