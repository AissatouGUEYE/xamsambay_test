...
@endsection
  <div class="row">
    <form  method="POST" id="add_produit_to_shop"  action="#" enctype="multipart/form-data">
      @csrf
        <div class="col s12">
            <div class="card">
                <div class="card-content pb-0">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="input-field col s6">
                                <select class=" browser-default unite" id="" name="unite_stock" required>
                        ...
                        <div class="row">
                            ...
                            <div class="input-field col s3">
                                <select required class=" browser-default unite" id="" name="unite_prix">
                                    <option value="" disabled selected>--Unite--</option>
                                </select>
                                <label class="active" for="activite">Unite</label>
                            </div>
                            ...
                            <div class="input-field col s12">
                                <div class="row load" id=""></div>
                                    ...
                                    <div class="col s12 display-flex justify-content-end mt-1">
                                        ...
                                        <a id="addProductToShopBtn" href="#" class="btn indigo">
                                            Enregistrer</a>
