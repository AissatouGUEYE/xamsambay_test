...
@section('ariane')
    ...
    <li class="breadcrumb-item">
        <a href="{{ url('/louma-mbay/boutiques') }}">Boutiques</a>
    </li>
...
@endsection
<div class="row">
    <form id="formModshop" action="/boutique/update" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="col s12">
            <div class="card">
                        ...
                        <div class="row">
                            <div class="input-field col s12">
                                ...
                                <div class="col s12 display-flex justify-content-end mt-1">
                                    <button type="submit" id="formModShopBtn" class="btn indigo">
                                        Enregistrer</button>
