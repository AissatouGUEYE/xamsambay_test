                        ...
                        <tbody id="">
                            @isset($etudiants)
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><div class='btn-group'><a href="/louma-du-savoir/cours/desinscrire/{{ $item['id'] }}/{{ $courseid }}" class='btn btn-danger btn-sm btnSupprimer'>Désinscrire</a></div></td>
                                </tr>
                                @endforeach
                            @endisset
