    ...
    <div class="users-list-table">
        <div class="card">
            <div class="card-content">
                ...
                <a target="_blank" href="https://loumadusavoir.mlouma.org/course/view.php?id={{ $courseid }}" class="text-center btn blue waves-effect waves-light btn-sm ml-3 right">S'inscrire</a>
