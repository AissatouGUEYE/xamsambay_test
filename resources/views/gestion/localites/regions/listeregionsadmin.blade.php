...
@section('ariane')
    ...
    <li class="breadcrumb-item">
        <a class="yellow-text">Liste des Régions</a>
      </li>
@endsection
            ...
            <div class="row">
                    ...
                    <div class="col s12 m6 l4 display-flex align-items-center show-btn">
                        ...
                        <a type="button" class="btn green waves-effect waves-light btn-sm ml-3"
                            {{-- href="{{ url('/louma-mbay/produits/create') }}"><i class="material-icons">add_circle</i> --}}
                            href="regions/create"><i class="material-icons">add_circle</i>
                            Région</a>
