...
@endsection
  <div class="row">
    <form  id="formAddLangue" action="/regions/edit" method="POST">
      @csrf
    <div class="col s12">
      <div class="card">
        <div class="card-content pb-0">
          <div class="card-header mb-2">
            <h4 class="card-title">Modification Région</h4>
          </div>
          <div class="card-body">
            
            <div class="row">

                <input id="id" name="id" value="{{ $region[0]['id'] }}" hidden>

                <div class="input-field col s6">
                    <input id="region" type="text" class="validate" name="region" value="{{ $region[0]['region'] }}">                
                    <label class="active" for="region">Nom de la Région</label>
                </div>
                <div class="input-field col s6">
                    <select class="select2 browser-default" id="pays" name="pays">
                      <option value="1" selected>Sénégal</option>
